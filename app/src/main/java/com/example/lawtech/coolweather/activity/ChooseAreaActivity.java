package com.example.lawtech.coolweather.activity;
...
import com.example.lawtech.coolweather.R;
...
import com.example.lawtech.coolweather.util.MyApplication;
...
public class ChooseAreaActivity extends Activity {
    ...
    private void queryDistricts() {
        districtList = coolWeatherDB.loadDistricts(selectedCity.getId());
    ...
    private void queryFromServer(final String type) {
        showProgressDialog();
        HttpUtil.sendHttpRequest("http://v.juhe.cn/weather/citys?key=7314489c0961d4acf5f9e52f59dbb1b4", new HttpCallbackListener() {
